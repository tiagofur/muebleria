...
//
// PlacementKind is the #350 provenance discriminator, never a guess:
// "manual" for placements authored on component-instance overrides (the only
// source today) and "derived" for placements generated by relationships/
...
const (
	// HardwarePlacementKindManual: placement authored on a component-instance
	// override (domain HardwarePlacement, #350 "manualHardwarePlacement").
	HardwarePlacementKindManual = "manual"
	// HardwarePlacementKindDerived: placement generated by a relationship/
	// joint rule (#356) — reserved for the rich authoring resolve (#467/#468).
	HardwarePlacementKindDerived = "derived"
)
