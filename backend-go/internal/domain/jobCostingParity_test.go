...
func TestBuildCostBaselineFreezesSnapshotAndRelease(t *testing.T) {
	...
	release := ResolveLegacyProductionRelease(&LegacyProductionRelease{
	...
	reRelease := ResolveLegacyProductionRelease(&LegacyProductionRelease{ID: "rel-2", ProjectID: "p1", ProjectVersion: 4, BOMFingerprint: "fp-bbb"})
