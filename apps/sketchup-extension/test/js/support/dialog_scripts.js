...
// granete-configurator.js). Harnesses execute the REAL files in dialog.html
...
function dialogSources() {
  ...
  return {
    ...
    configurator: fs.readFileSync(path.join(RESOURCES, 'js/granete-configurator.js'), 'utf-8')
  };
}

// Runs the dialog scripts in dialog.html load order (granete-media.js,
// granete-account.js, granete-library.js, granete-configurator.js, then the
// inline bootstrap) inside an already-created vm context.
