...
# conectado y local), sesión y reentrada, tool, base planes y geometría.
  ...
  module SketchUpExtension
    module UserInterface
      module PlacementPreviewBridge # rubocop:disable Metrics/ModuleLength
        # Unit-length/orthogonality tolerance for oriented target frames:
        # host transform axes are floating-point values.
        UNIT_EPSILON = 1e-6
