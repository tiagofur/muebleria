...
if [[ ! -f "$ENV_FILE" ]]; then
  ...
  REQUIRED_VARS="DOMAIN POSTGRES_USER POSTGRES_PASSWORD APP_DATABASE_PASSWORD POSTGRES_DB JWT_SECRET REFRESH_TOKEN_PEPPER MEDIA_SIGNING_KEY CORS_ALLOWED_ORIGINS"
