...
export abstract class GeneratedGraneteApiClient {
  ...
  updatePlatformOrganization(token: string, id: string, version: number, body: UpdatePlatformOrganizationRequest, signal?: AbortSignal): Promise<PlatformOrganization> { return this.request("PATCH", `/platform/organizations/${encodeURIComponent(id)}`, { schema: "PlatformOrganization", token, ifMatch: version, bodySchema: "UpdatePlatformOrganizationRequest", body, signal }); }
