/**
 * Material category management: manage-list modal + create/edit form modal +
 * delete confirmation for the workshop materials (MaterialBoard) catalog (F142).
 */
...
import { ManageCategoryRows } from '../ambient/AmbientCategoryTree';

export interface MaterialCategoryModalsProps {
...
export function MaterialCategoryModals({
  open,
  onClose,
  categories,
  onCreateCategory,
  ...
  onDeleteCategory,
  onAfterDelete,
}: MaterialCategoryModalsProps): ReactNode {
  ...
  return (
    <>
      ...
      <Modal
        open={open}
        onClose={onClose}
        title="Administrar categorías de materiales"
        size="md"
        dataTestId="material-category-manage-modal"
        footer={
          <>
            <button
              type="button"
              ...
              data-testid="material-category-create-btn"
            >
        ...
        <div className="module-category-manage">
          {categories.length === 0 ? (
            <EmptyState
              ...
              description="Creá categorías para organizar los tableros y materiales del taller (ej. Maderas, Unicolores, Metales)."
      ...
      <Modal
        ...
        title={editingCatId ? 'Editar categoría de material' : 'Nueva categoría de material'}
        size="sm"
        dataTestId="material-category-form-modal"
        footer={
          <>
            <button
              type="button"
            ...
            <button
              ...
              className="btn btn--primary"
              form={catFormId}
              data-testid="material-category-submit"
            >
              Guardar
            </button>
          </>
      ...
      >
        <form id={catFormId} className="catalog-form" onSubmit={handleCategorySubmit}>
          ...
          <div className="catalog-form__field">
            <label htmlFor="mat-cat-name">Nombre</label>
            <input
              id="mat-cat-name"
              value={catDraft.name}
              onChange={(e) =>
              ...
              placeholder="Ej. Maderas, Unicolores, Enchapados…"
              autoComplete="off"
              required
              data-testid="material-category-name-input"
            />
          </div>
          <div className="catalog-form__field">
            <label htmlFor="mat-cat-parent">Categoría padre (opcional)</label>
            <select
              id="mat-cat-parent"
              ...
              data-testid="material-category-parent-select"
            >
      ...
      <Modal
        ...
        size="sm"
        dataTestId="material-category-delete-confirm-modal"
        footer={
          <>
            <button
              type="button"
            ...
            <button
              ...
              data-testid="material-category-confirm-delete"
            >
              Eliminar
            </button>
          </>
      ...
      >
        <p>
          ...
          <strong>{deleteCatTarget?.name}</strong>? Los materiales asignados a
