...
9. `packages/excel/src/ptx/`: compiler, validator, serializer, parser y verifier.
10. `contracts/machineOutputCatalog.contract.json`: catálogo compartido con paridad
