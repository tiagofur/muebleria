...
- Approval: prompt del propietario (2026-09-11), PR 5 de #650 con spec expandida de 33 secciones ("continuar PTX + integración CADmatic sin tocar Cotización/Diseño"). Dependencia verificada: PR #656 MERGED en origin/main@25c2cbb55f86d379ffba9c47844ce850552b09f9. Frente Cotización/Diseño (agente paralelo) fuera de alcance; origin/main sin movimiento.
- Started: 2026-09-11. Branch `feat/650-cut-program-to-ptx`, base `origin/main@25c2cbb5`. Single writer.
- Result: `IMPLEMENTED_PENDING_REVIEW` → `progress/implementation_650_ptx_compiler.md`. Compilador `compileCutPlanToPtxDocument` + `verifyCutPlanPtxReadback` + golden `LAB_FIXTURE NOT_MACHINE_VALIDATED` en `packages/excel/src/ptx/`. R1 (primera versión, commit ec7753fe en rama renombrada) revisada contra la spec expandida: trims ahora FAIL CLOSED (antes fase 1/2), title explícito en options, representabilidad estricta sin redondeo silencioso, CUT_INDEX=preorder estructural vs SEQUENCE=orden de ejecución (caso no intercambiable probado, como fragmento 03), mapping inverso bidireccional, casos A–G con optimizeCutPlan real, mutaciones semánticas (dimension/sequence/function/part-ref/orden/kerf/vector/fila borrada), comparación preview↔PTX a nivel dominio (280 vs 734).
- Evidence: `@granete/excel` 36 archivos / 269 tests (+3 skipped hardware preexistentes); monorepo domain 105/1407, ui 160/1704, web 35/444, storage 12/191, desktop 3/17, mobile 10/73; `pnpm typecheck` 7/7; `pnpm openapi:check` sin drift; `git diff --check` limpio.
