...
- Delivery: partial según PR #750 al momento del merge; la verificación restante declarada allí (browser E2E + storage completo) fue completada después sobre el MISMO HEAD `d5d6dbbd` y queda registrada en este entry y en el comentario del PR. Sin implementar (dueños propios): #740 finalización/gates físicos, #741 continuidad P1/P2, #682 historial etiquetas/QR, serializadores no soportados → #650.
