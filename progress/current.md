...
- Approval: issue #788 OPEN `status:approved`, `type:bug`, `high`, `domain`, parent #787 (verificada al iniciar; 0 PRs abiertos — sin trabajo concurrente). Base `origin/main@41ca73b2` (post-merge #783/#786). Rama `fix/788-ptx-strict-spec-preflight`. Un writer. Sólo #788: sin etiquetas (#789), receiver (#790), CUTS (#791), RLT (#792), profile r5/adapter 1.4.0 (#793).
